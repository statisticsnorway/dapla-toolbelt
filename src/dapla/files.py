...
class FileClient:
    ...
    def get_versions(bucket_name: str, file_path: str) -> Any:
        ...
        try:
            ...
            print("Sorry, mentioned bucket does´t exist. ")
            return []
...
def cat(gcs_path: str) -> str:
    ...
    """
    return t.cast(str, FileClient.get_gcs_file_system().cat(gcs_path).decode("utf-8"))


@staticmethod
def gcs_open(gcs_path: str, mode: str = "r") -> TextIOWrapper | AbstractBufferedFile:
