...
class TestFiles(unittest.TestCase):
    ...
    @patch("google.cloud.storage.Client")
    def test_list_versions_empty_bucket(self, mock_client):
    ...
    @patch("google.cloud.storage.Client")
    def test_restore_version_success(self, mock_client):
        mock_bucket = Mock()
    ...
    @patch("google.cloud.storage.Client")
    def test_restore_version_existing_live_version(self, mock_client):
        mock_bucket = Mock()
        mock_source_blob = Mock()
        mock_client.return_value.bucket.return_value = mock_bucket
        mock_bucket.blob.return_value = mock_source_blob
